...
import ServiceTabData from "./WSDServiceTabData";
import ServiceTabItem from "./WSDServiceTabItem";

const ServiceWebsiteDevlopment = () => {
    ...
    <>
      ...
      <section id="features" className="py-20 lg:py-25 xl:py-10">
        ...
        <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top mb-15 mt-15 flex flex-wrap justify-center rounded-[10px] border border-stroke bg-white shadow-solid-5 dark:border-strokedark dark:bg-blacksection dark:shadow-solid-6 md:flex-nowrap md:items-center lg:gap-7.5 xl:mb-21.5 xl:gap-12.5"
          >
            <div
              ...
              className={`relative flex w-full cursor-pointer items-center gap-4 border-b border-stroke px-6 py-2 last:border-0 dark:border-strokedark md:w-auto md:border-0 xl:px-13.5 xl:py-5 ${currentTab === "tabOne"
                  ? "active before:absolute before:bottom-0 before:left-0 before:h-1 before:w-full before:rounded-tl-[4px] before:rounded-tr-[4px] before:bg-green-800"
                  : ""
                }`}
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                ...
                Precision-Crafted Web Solutions
                </button>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                <button className="text-center text-sm font-medium text-black dark:text-white xl:text-regular">
                Crafting Your Digital Success:Partner with Be Digital 
                </button>
              </div>
            </div>
          ...
          >
            {ServiceTabData.map((feature, key) => (
              <div
                className={feature.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <ServiceTabItem featureTab={feature} />
              </div>
            ))}
          </motion.div>
      </section >
...
export default ServiceWebsiteDevlopment;
