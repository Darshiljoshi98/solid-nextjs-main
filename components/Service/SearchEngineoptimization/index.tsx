...
import ServiceTabData from "./SEOServiceTabData";
import ServiceTabItem from "./SEOServiceTabItem";
          ...
          >
            ...
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                ...
                Be Found First on The Search Engine Results with Us
                </button>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                <button className="text-center text-sm font-medium text-black dark:text-white xl:text-regular">
                Let Be Digital be your guiding light!
                </button>
              </div>
            </div>
